...
const { User, Department, Task, TaskMetrics, UserPerformance, DepartmentAnalytics, sequelize, syncModels } = require('../models');
...
beforeAll(async () => {
  try {
    ...
    // Create TaskMetrics for export date range
    ...
    // Create UserPerformance for export date range
